export const preConfirmationTranslations = {
  es: {
    ...
    description:
      "Para garantizar la precisión de los informes y el cumplimiento de los estándares profesionales, solicitamos los datos básicos de su centro médico.",
    feature_1_title: "Identidad Institucional",
    feature_1_desc:
      "El nombre legal del centro se incluirá en el encabezado de todos los diagnósticos generados.",
    feature_2_title: "Validez Profesional",
    feature_2_desc:
      "Aseguramos que la documentación emitida cumpla con los requisitos de contacto y ubicación necesarios.",
    ...
    footer_note:
      "Esta información podrá ser actualizada posteriormente en el panel de configuración.",
    btn_next: "Continuar",
  },
  en: {
    step: "Step 1 of 2",
    ...
    description:
      "To ensure report accuracy and professional standards compliance, please provide your medical center's primary information.",
    feature_1_title: "Institutional Identity",
    feature_1_desc:
      "The legal clinic name will be displayed on the header of all generated diagnostics.",
    feature_2_title: "Professional Validity",
    feature_2_desc:
      "We ensure all issued documentation meets necessary contact and location requirements.",
